		...
		<swiper class="list-wrapper" :current="selectedIndex" @change="changeList">
			...
			<swiper-item class="list-item">
				...
				>
					...
					<LoadingMore :loading="guanzhu.loading" :loadall="guanzhu.loadall"></LoadingMore>
				</scroll-view>
			</swiper-item>
			...
			<swiper-item class="list-item">
				...
				>
					...
					<LoadingMore :loading="tuijian.loading" :loadall="tuijian.loadall"></LoadingMore>
				</scroll-view>
			</swiper-item>
			...
			<swiper-item class="list-item">
				...
				>
					...
					<LoadingMore :loading="lianghui.loading" :loadall="lianghui.loadall"></LoadingMore>
				</scroll-view>
			</swiper-item>
			...
			<swiper-item class="list-item">
				...
				>
					...
					<LoadingMore :loading="shipin.loading" :loadall="shipin.loadall"></LoadingMore>
				</scroll-view>
			</swiper-item>
			...
			<swiper-item class="list-item">
				...
				>
					...
					<LoadingMore :loading="jinan.loading" :loadall="jinan.loadall"></LoadingMore>
				</scroll-view>
			</swiper-item>
			...
			<swiper-item class="list-item">
				...
				>
					...
					<LoadingMore :loading="xiaoshipin.loading" :loadall="xiaoshipin.loadall"></LoadingMore>
				</scroll-view>
			</swiper-item>
			...
			<swiper-item class="list-item">
				...
				>
					...
					<LoadingMore :loading="redian.loading" :loadall="redian.loadall"></LoadingMore>
				</scroll-view>
			</swiper-item>
			...
			<swiper-item class="list-item">
				...
				>
					...
					<LoadingMore :loading="yule.loading" :loadall="yule.loadall"></LoadingMore>
				</scroll-view>
			</swiper-item>
			...
			<swiper-item class="list-item">
				...
				>
					...
					<LoadingMore :loading="junshi.loading" :loadall="junshi.loadall"></LoadingMore>
				</scroll-view>
			</swiper-item>
			...
			<swiper-item class="list-item">
				...
				>
					...
					<LoadingMore :loading="yinyue.loading" :loadall="yinyue.loadall"></LoadingMore>
				</scroll-view>
			</swiper-item>
		</swiper>
	</view>
